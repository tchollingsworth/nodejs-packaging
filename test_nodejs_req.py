...
def test_process_dep():
    ...
    #assert process_dep('npm(a)', '=v1')     == 'npm(a) = 1'
    ...
    #assert process_dep('npm(a)', '=v1.2')   == 'npm(a) = 1.2'
    assert process_dep('npm(a)', '1.2.3')   == 'npm(a) = 1.2.3'
    assert process_dep('npm(a)', '=1.2.3')  == 'npm(a) = 1.2.3'
    assert process_dep('npm(a)', 'v1.2.3')  == 'npm(a) = 1.2.3'
    #assert process_dep('npm(a)', '=v1.2.3') == 'npm(a) = 1.2.3'
    ...
    assert process_dep('npm(a)', '>=1.2 <=2.3')     == '(npm(a) >= 1.2 with npm(a) <= 2.3)'
    assert process_dep('npm(a)', '>=1.2.3 <=2.3.4') == '(npm(a) >= 1.2.3 with npm(a) <= 2.3.4)'
    assert process_dep('npm(a)', '<2 >1')           == '(npm(a) < 2 with npm(a) > 1)'
    assert process_dep('npm(a)', '<2.3 >1.2')       == '(npm(a) < 2.3 with npm(a) > 1.2)'
    assert process_dep('npm(a)', '<2.3.4 >1.2.3')   == '(npm(a) < 2.3.4 with npm(a) > 1.2.3)'
    assert process_dep('npm(a)', '<=2 >=1')         == '(npm(a) <= 2 with npm(a) >= 1)'
    assert process_dep('npm(a)', '<=2.3 >=1.2')     == '(npm(a) <= 2.3 with npm(a) >= 1.2)'
    assert process_dep('npm(a)', '<=2.3.4 >=1.2.3') == '(npm(a) <= 2.3.4 with npm(a) >= 1.2.3)'
    ...
    assert process_dep('npm(a)', '^1.x')    == '(npm(a) >= 1 with npm(a) < 2)'
    assert process_dep('npm(a)', '^1')      == '(npm(a) >= 1 with npm(a) < 2)'
    assert process_dep('npm(a)', '^0.0.x')  == '(npm(a) >= 0.0 with npm(a) < 0.1)'
    #assert process_dep('npm(a)', '^0.0')    == '(npm(a) >= 0.0 with npm(a) < 0.1)'
    ...
    #assert process_dep('npm(a)', '>1.2 <2.0 <1.9') == '(npm(a) > 1.2 with npm(a) < 2.0 with npm(a) < 1.9)'
    assert process_dep('npm(a)', '>1.2 <2.0 <1.9') == '(npm(a) > 1.2 with npm(a) < 2.0)'
